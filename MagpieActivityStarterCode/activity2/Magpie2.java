...
public class Magpie2
{
    ...
    public String getResponse(String statement) {
		...
		response = "Do you enjoy music?";
	    }
	    else if (statement.indexOf("movie") >= 0) {
		response = "Do you like the movies?";
	    }
	    else if (statement.indexOf("food") >= 0) {
		response = "I can't relate because robots don't eat.";
	    }
	...
	private String getRandomResponse()
	{
		...
		else if (whichResponse == 4) { response = "I don't believe you."; }
		else { response = "Where did you come from?"; }
		return response;
	}
}
